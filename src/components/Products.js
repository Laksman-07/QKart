...
const Products = () => {
  ...
  return (
    <div>
      ...
      { isLoading?<Box textAlign="center"><CircularProgress />Loading Progress </Box>
      :<Grid container spacing={2} sx={{paddingTop:"1rem"}}> {res.length === 0 && <p style={{textAlign:"center",margin:"0 auto"}}>No products found</p> }{res.map((data,index) =>
      <Grid item xs={6} md={3}>
